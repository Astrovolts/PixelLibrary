...
using PixelLibrary.ScreenCapture;
...
namespace PixelLibrary.Processing
{
    public class PixelSearcher
    {
        ...
        EnemyShapeDetector enemyShapeManager = new EnemyShapeDetector();
        ...
        public unsafe EnemyShape[] PixelSearch()
        {
            EnemyShape[] enemies = null;
            ...
            try
            {
                using (var bitmap = _screenCapture.GetNextFrame())
                {
                    ...
                    //enemies = enemyShapeDetector.FindEnemies(bitmap);
                    return enemies;
                }
            }
            catch (Exception e)

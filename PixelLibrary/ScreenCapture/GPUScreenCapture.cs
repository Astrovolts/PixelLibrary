            ...
            try
            {
                ...
                try
                {
                    BitmapData bmpData = _capturedImage.LockBits(
                        new Rectangle(0, 0, _captureRectangle.Width, _captureRectangle.Height),
                    ...
                    try
                    {
                        ...
                        {
                            nint srcPtr = dataBox.DataPointer + y * dataBox.RowPitch;
                            nint destPtr = bmpData.Scan0 + y * bmpData.Stride;
